                ...
                >
                  <div className="max-w-5xl mx-auto bg-blue-950 backdrop-blur-xl rounded-3xl shadow-2xl border border-blue-800 overflow-hidden hover:shadow-3xl hover:border-blue-700 transition-all duration-500">
                    <div className="grid md:grid-cols-2">
                      ...
                      {/* Right Side - CTA Section with Background Image */}
                      <div className={`bg-gradient-to-br ${course.color} p-6 md:p-8 lg:p-12 flex flex-col justify-center items-center text-white relative overflow-hidden`}>
                        {/* Background Image - Course Specific CTA (More Transparent) */}
                        ...
                        <div className="relative z-10 text-center">
                          ...
                          <div className="space-y-3">
                            <button
                              ...
                              className="w-full px-4 py-3 md:px-6 md:py-4 bg-white text-gray-900 font-bold rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
                            >
                            ...
                            <button
                              ...
                              className="w-full px-4 py-3 md:px-6 md:py-4 bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white font-semibold rounded-xl hover:bg-white/20 transition-all duration-300"
                            >
                              Know More
                            </button>
                          </div>
