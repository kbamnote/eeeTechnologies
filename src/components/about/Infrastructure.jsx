  ...
  return (
    <section className="py-20 bg-[#F8FAFC] relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-[#06B6D4]/30 rounded-full blur-3xl" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#1F2937] max-w-2xl mx-auto mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {stats.map((stat, index) => (
                <div key={index} className="text-center group">
                  <div className="bg-[#F8FAFC]/80 backdrop-blur-sm border border-[#3B82F6]/20 rounded-2xl p-6 hover:shadow-2xl hover:border-[#3B82F6]/30 transition-all duration-500 group-hover:-translate-y-2 shadow-lg">
              ...
              <button
                ...
                className={`px-6 py-3 rounded-2xl font-semibold transition-all duration-300 ${
                  activeTab === tab.id
                    ...
                    : 'bg-[#F8FAFC]/70 backdrop-blur-xl text-[#1F2937]/80 hover:bg-[#F8FAFC] border border-[#3B82F6]/20 hover:border-[#3B82F6]/30'
                }`}
              >
          ...
          <motion.div
            ...
            className="bg-[#F8FAFC]/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-[#3B82F6]/20 overflow-hidden shadow-lg"
          >
            ...
            {getTabContent().map((item, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-[#F8FAFC]/50 backdrop-blur-xl rounded-3xl p-6 md:p-8 border border-[#3B82F6]/20 overflow-hidden hover:shadow-3xl hover:border-[#3B82F6]/30 transition-all duration-500">
                  {/* Icon */}
                  <div className={`w-14 h-14 bg-[#3B82F6] rounded-2xl flex items-center justify-center mb-6`}>
                  ...
                  <div className="space-y-3">
                    {item.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex items-center">
                        ...
                        <span className="text-[#1F2937]/70 text-sm">
                          {feature}
                        </span>
                      </div>
                    ))}
          ...
          <motion.div variants={itemVariants} className="text-center">
            <div className="bg-[#F8FAFC] rounded-2xl p-8 md:p-12 relative overflow-hidden border border-[#3B82F6]/20 shadow-lg">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-[#1F2937] mb-8 max-w-3xl mx-auto">
